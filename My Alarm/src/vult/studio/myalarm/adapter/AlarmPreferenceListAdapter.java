package vult.studio.myalarm.adapter;
...
import vult.studio.myalarm.preferences.AlarmPreference.Type;
...
//		
	...
	public void setMathAlarm(Alarm alarm) {
		this.alarm = alarm;
		preferences.clear();
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_ACTIVE,"Turn on", null, null, alarm.getAlarmActive(),Type.BOOLEAN));
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_NAME, "Note",alarm.getAlarmName(), null, alarm.getAlarmName(), Type.STRING));
		...
		preferences.add(new AlarmPreference(AlarmPreference.Key.ALARM_DIFFICULTY,"Level", alarm.getDifficulty().toString(), alarmDifficulties, alarm.getDifficulty(), Type.LIST));
